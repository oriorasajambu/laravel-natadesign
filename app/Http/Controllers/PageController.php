...
class PageController extends Controller
{
    public function index()
    {
        ...
        $articles = Post::where('category_id', '!=', 1)->whereNotNull('published_at')->orderBy('published_at', 'DESC')->take(3)->get();
        $motto = Motto::first();
        $faqs = Faq::all();
    ...
    public function articles()
    {
        ...
        $articles = Post::where('category_id', '!=', 1)->whereNotNull('published_at')->orderBy('published_at', 'DESC')->paginate(9);
        $medias = Post::where('category_id', 1)->whereNotNull('published_at')->orderBy('published_at', 'DESC')->take(3)->get();
        $albums = Album::orderBy('position', 'DESC')->take(3)->get();;
        $contact = Contact::first();
        $data = [
            'seo' => $seoCategory->seo,
    ...
    {
        $seoCategory = SeoCategory::where('name', 'LIKE', '%articles%')->firstOrFail();
        $medias = Post::where('category_id', 1)->whereNotNull('published_at')->orderBy('published_at', 'DESC')->paginate(9);
        $articles = Post::where('category_id', '!=', 1)->whereNotNull('published_at')->orderBy('published_at', 'DESC')->take(3)->get();
        $albums = Album::orderBy('position', 'DESC')->take(3)->get();;
        $contact = Contact::first();
        $data = [
