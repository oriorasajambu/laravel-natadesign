<div id="lightShowModal" style="display: none" onclick="closeModal()" class="fixed z-10 left-0 top-0 w-screen h-screen overflow-hidden backdrop-blur-md bg-white/30">
