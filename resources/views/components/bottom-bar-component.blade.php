<div class="landscape:lg:py-20 landscape:md:py-20 landscape:sm:py-5 landscape:ssm:py-5 landscape:xs:py-5 portrait:lg:py-20 portrait:md:py-20 portrait:sm:py-5 portrait:ssm:py-5 portrait:xs:py-5 lg:px-20 md:px-0 sm:px-0">
    <div
        ...
        <p
            class="text-white opacity-50 font-dm-sans lg:text-base md:text-sm sm:text-sm italic lg:text-center md:text-left sm:text-left ssm:text-center xs:text-center">
            We are
            Architects and
            Interior Design
            specialists in the field of F&B.
        </p>
        <div class="w-auto lg:hidden md:hidden sm:hidden xs:block">
            <ul class="lg:hidden md:hidden sm:hidden ssm:hidden xs:flex flex-row justify-center">
                <li>
        ...
        <div class="hidden w-full lg:block md:block sm:block ssm:block lg:w-auto md:mt-auto sm:mt-auto ssm:mt-auto">
            <ul
                class="flex flex-row lg:justify-center md:justify-end sm:justify-end ssm:justify-center gap-8 md:text-sm ssm:text-sm sm:text-sm md:font-medium md:border-0 content-end">
                <li>
                    <a href="https://www.facebook.com/nataproduct" rel="external" aria-label="Facebook" target="_blank"
                ...
                <li>
                    <a href="https://www.tiktok.com/@nat.adesign" rel="external" aria-label="Tiktok" target="_blank"
                        class="block text-white font-dm-sans md:bg-transparent">Tiktok</a>
                </li>
                <li>
                    <a href="https://wa.me/6281212301500" rel="external" aria-label="Whatsapp" target="_blank"
                        class="block text-white font-dm-sans md:bg-transparent">Whatsapp</a>
                </li>
            </ul>
        </div>
    </div>
