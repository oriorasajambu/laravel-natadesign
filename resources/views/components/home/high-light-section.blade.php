        ...
        <div class="grid grid-cols-1 w-full">
            <div class="page-section flex flex-col opacity-0">
                <div class="w-full grow self-center relative aspect-section">
                    <img class="aspect-section w-full" srcset="{{ asset('assets/highlight-lg.webp') }} 1040w, {{ asset('assets/highlight-md.webp') }} 608w" src="{{ asset('assets/highlight-fallback.webp')}}" alt="Highligt Image" />
