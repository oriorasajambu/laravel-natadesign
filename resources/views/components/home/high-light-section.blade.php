        ...
        <div class="grid grid-cols-1 w-full">
            <div class="page-section flex flex-col opacity-0">
                <div class="w-full grow self-center relative aspect-section">
                    <img class="aspect-section w-full" loading="lazy" srcset="{{ asset('assets/highlight-lg.webp') }} 1040w, {{ asset('assets/highlight-md.webp') }} 608w" src="{{ asset('assets/highlight-fallback.webp')}}" alt="Highligt Image" />
                ...
                <div class="flex flex-wrap lg:flex-nowrap items-center justify-between mt-6">
                    ...
                    <a aria-label="See Our Gallery" href="/portofolio" class="flex items-center text-[#404040] font-dm-sans font-bold">
                        Lihat Gallery Kami
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-primary ml-6" width="25.144" height="14.382"
