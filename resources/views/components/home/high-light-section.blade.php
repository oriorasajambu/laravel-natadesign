        ...
        <div class="grid grid-cols-1 w-full">
            <div class="page-section flex flex-col opacity-0">
                <div class="w-full grow self-center relative aspect-section">
                    <img class="aspect-section w-full" srcset="{{ asset('assets/highlight-lg.png') }} 1040w, {{ asset('assets/highlight-md.png') }} 608w" src="{{ asset('assets/highlight.jpg')}}" alt="Highligt Image" />
