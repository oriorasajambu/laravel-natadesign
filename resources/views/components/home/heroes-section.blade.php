                    ...
                    <div class="animate-bounce hidden lg:mr-10 md:mr-5 sm:mr-3 lg:block md:block sm:block self-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="167.953"
                            ...
                            <g id="Group_28" data-name="Group 28" transform="translate(-1)" opacity="0.5">
                                <text id="Scroll" transform="translate(4) rotate(90)" fill="#fff" fontSize="12"
                                    fontFamily="SegoeUI, Segoe UI">
                                    <tspan x="0" y="0">Scroll</tspan>
                                </text>
                                <path id="Path_5" data-name="Path 5" d="M1098,342.6V456.3"
                                    transform="translate(-1089.5 -288.35)" fill="none" stroke="#fff"
                                    strokeWidth="1" />
                                <circle id="Ellipse_5" data-name="Ellipse 5" cx="7" cy="7"
                                    r="7" transform="translate(1 75)" fill="#fff" />
                                <circle id="Ellipse_6" data-name="Ellipse 6" cx="4" cy="4"
                                    r="4" transform="translate(4 113)" fill="#fff" />
                                <circle id="Ellipse_7" data-name="Ellipse 7" cx="4" cy="4"
                                    r="4" transform="translate(4 145)" fill="#fff" />
                            </g>
                        </svg>
                    </div>
                </div>
            </div>
            <x-bottom-bar-component />
        </div>
    </div>
</div>
