<div class="bg-[#FFFBF2] pb-20 flex flex-row justify-center">
    <div
        ...
        <div class="lg:py-20 lg:px-20 md:px-20 sm:px-0 relative">
            ...
            <button aria-label="Previous Testimony"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55">
                    <g id="Group_225" data-name="Group 225" transform="translate(-140 -7288)">
                        <g id="Ellipse_4" data-name="Ellipse 4" transform="translate(140 7288)" fill="none"
                            stroke="#10403c" strokeWidth="1">
                            <circle cx="27.5" cy="27.5" r="27.5" stroke="none" />
                            <circle cx="27.5" cy="27.5" r="27" fill="none" />
                        </g>
                        <path id="Path_17" data-name="Path 17" d="M0,12,12,0,24,12"
                            transform="translate(159.5 7327.5) rotate(-90)" fill="none" stroke="#10403c"
                            strokeWidth="1" />
                    </g>
                </svg>
            </button>
            <button aria-label="Next Testimony"
                class="hidden lg:block md:block absolute top-1/2 -translate-y-1/2 right-0 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55">
                    <g id="Group_226" data-name="Group 226" transform="translate(-1205 -7316)">
                        <g id="Ellipse_4" data-name="Ellipse 4" transform="translate(1260 7371) rotate(180)"
                            fill="none" stroke="#10403c" strokeWidth="1">
                            <circle cx="27.5" cy="27.5" r="27.5" stroke="none" />
                            <circle cx="27.5" cy="27.5" r="27" fill="none" />
                        </g>
                        <path id="Path_17" data-name="Path 17" d="M0,12,12,0,24,12"
                            transform="translate(1240.5 7331.5) rotate(90)" fill="none" stroke="#10403c"
                            strokeWidth="1" />
                    </g>
                </svg>
            </button>
